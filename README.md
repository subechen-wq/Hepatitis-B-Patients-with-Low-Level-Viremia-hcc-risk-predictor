...
[![Streamlit App](https://hcc-risk-predictor-laaavtlojk9bfhctqywxgm.streamlit.app/#b-hcc) [![Python 3.11+](https://img.shields.io/badge/python-3.11+-blue.svg)](https://www.python.org/downloads/)
...
1.  **性別 (Gender)**
2.  **年齡 (Age)** —— 動態連續變數動態計算
3.  **肝硬化 (Cirrhosis)** —— 經影像學、肝纖維化掃描或切片確診
4.  **血小板計數 (Platelet count)**
5.  **AST 數值 (GOT)**

---

## 🚀 本地端快速啟動 (Local Installation)

若您想在本地電腦運行此 App，請按照以下步驟操作：
...
無分層聲明：本研究原始文獻僅提供 Cox 回歸預測模型以計算發生機率，未定義絕對的臨床高低風險分層。百分位區間僅為研究群體之相對比較。
